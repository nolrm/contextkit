...
Before writing code, read the relevant standards files above. Always follow the project's established patterns and conventions.

If a task touches architecture, testing, naming, or workflow conventions, consult the matching standards file first.
