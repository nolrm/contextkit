...
describe('ClaudeIntegration', () => {
  ...
  test('13. does not write .claude/settings.json even when Node.js format/lint tooling is present', async () => {
    ...
    expect(await fs.pathExists('.claude/settings.json')).toBe(false);
  });
